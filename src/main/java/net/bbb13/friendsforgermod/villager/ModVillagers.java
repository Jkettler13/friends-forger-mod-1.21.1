package net.bbb13.friendsforgermod.villager;
...
public class ModVillagers {
    ...
    private static PointOfInterestType registerPoi(String name, Block block) {
        return PointOfInterestHelper.register(Identifier.of(FriendsForgerMod.MOD_ID, name), 1, 1, block);
    }
    ...
    public static void registerVillagers() {
        FriendsForgerMod.LOGGER.info("Registering Villagers for " + FriendsForgerMod.MOD_ID);
    }
}
